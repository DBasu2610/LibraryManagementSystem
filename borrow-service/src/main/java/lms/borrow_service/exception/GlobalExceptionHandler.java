...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleBorrowNotFound(BorrowNotFoundException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("status", HttpStatus.NOT_FOUND.value());
        body.put("error", "Borrow Not Found");
    ...
    public ResponseEntity<Object> handleBookNotAvailable(BookNotAvailableException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("status", HttpStatus.CONFLICT.value());
        body.put("error", "Book Not Available");
        body.put("message", ex.getMessage());
